...
def main():
    ...
    net = ECGLSTM(216, 100, 1, 2)
    model_dir = "/Users/alainamahalanabis/Documents/GAN_XAI/src/results/ecg/ECGLSTM_Normal/generator.pt"
...
def train_classifier(net, train_config, model_dir, n=10000, ch_path=None, batch_size=128, beat_type='N', gan_type=None):
    ...
    with torch.no_grad():
        ...
        input_noise = torch.Tensor(np.random.normal(0, 1, (128, 100)))
    ...
    for epoch in range(4):  # loop over the dataset multiple times
        ...
        for i, data in enumerate(dataloader):
            ...
            print ("length of ecg batch", len(ecg_batch[0]))

            b_size = ecg_batch.shape
            print ("b_size ", b_size)
            labels = data['label']
            ...
            outputs_class = torch.max(outputs, 1)
            print ("OUTPUTS CLASS")
            print (outputs_class)
